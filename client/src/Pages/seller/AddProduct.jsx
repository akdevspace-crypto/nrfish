...
import toast from 'react-hot-toast';
 ...
 function AddProduct() {
  ...
  if (
    ...
    !price || !offerPrice ||
    files.length === 0 || files.every(file => !file)
  ) {
  ...
  try {
   ...
   return (
    ...
    <form onSubmit={onSubmitHandler} className="md:p-10 p-4 space-y-5 max-w-lg">
        ...
        <button className="cursor-pointer hover:bg-primary-dull px-8 py-2.5 bg-primary text-white font-medium rounded">ADD</button>
    </form>
</div>
   )
 }
